...
Alt1 app for RuneScape 3 that watches a manually selected chat area and alerts when it sees nearby soul messages:
...
- This app is built for Alt1 and RS3, not RuneLite.
